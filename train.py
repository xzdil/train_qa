        ...
        for epoch_num in range(self.num_epochs):
            ...
            with torch.enable_grad(), tqdm(
                ...
                for batch in train_dataloader:
                    ...
                    if (global_idx >= global_idx_count * 300) and rank == 0:
            ...
            for epoch_num in range(self.num_epochs_pretrain):
                ...
                with torch.enable_grad(), tqdm(
                    ...
                    for batch in pretrain_dataloader:
                        ...
                        if (
                            pretrain_step_idx >= pretrain_eval_count * 500
                        ) and rank == 0:
...
def main(rank, world_size, args):
    ...
    if args.model_type == "distilbert":
        ...
        model = torch.load("save/pretrain_moe-efbc32e1-1e82-46fb-959c-009607526d2b/checkpoint/model_moe_final.pt")
        print("Model loaded!")
    ...
    if args.do_train:
        ...
        if rank == 0:
            ...
            ood_val_dataset, ood_val_dict = get_dataset(args, tokenizer,"test.jsonl", "ood_val")
